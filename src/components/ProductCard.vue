...
const displayImage = computed(() => {
  return props.product.imageUrl
    ? `${baseUrl}/${props.product.imageUrl}`
...
<template>
  <div
    class="card h-100 shadow-sm product-card custom-dark-card"
    :class="{'opacity-75': !product.isAvailable}"
  >
    <!-- Badge Hết hàng -->
    ...
    <div class="card-body d-flex flex-column">
      <div class="d-flex justify-content-between align-items-start mb-2">
        ...
        <span
          ...
          class="badge bg-warning text-dark ms-2 text-truncate"
      ...
      <p
        class="card-text text-light opacity-75 small flex-grow-1"
        style="
          display: -webkit-box;
          -webkit-line-clamp: 2;
          line-clamp: 2;
